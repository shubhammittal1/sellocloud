...
//			addIndexes(obj, t);
	...
	@Override
	public String saveEntityNew(final T t) throws Exception {
		RiakClient riakClient = riakClientFactory.getRiakClient();
		String json = null;
		String keyObject = null;
		BaseBucketModel baseBucketModel = BucketModelFactory
...
//			addIndexes(obj, t);
	...
	@Override
	public List<T> getEntityByLocationKeyBatch(List<String> keys, final Class<T> classVal) throws Exception {
		final List<T> list = new ArrayList<T>();
		final BaseBucketModel baseBucketModel = BucketModelFactory.getCustomBucketModel(classVal);
		ExecutorService executor = new ThreadPoolExecutor(10, 15, 0L, TimeUnit.MILLISECONDS, new LinkedBlockingQueue<Runnable>());
