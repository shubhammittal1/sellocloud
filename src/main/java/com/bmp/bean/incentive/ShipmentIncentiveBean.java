...
public class ShipmentIncentiveBean {
	...
	Map<String, Double> pickDrsAmtMap;
	
	public ShipmentIncentiveBean(){
		super();
	}
	...
	public Map<String, Double> getPickDrsAmtMap() {
		return pickDrsAmtMap;
	}

	public void setPickDrsAmtMap(Map<String, Double> pickDrsAmtMap) {
		this.pickDrsAmtMap = pickDrsAmtMap;
	}
