...
public class BfilMerchantReturned {
	
	@JsonProperty("LoanProposalID")
	private String LoanProposalID;
	
	@JsonProperty("RDSPReturnDate")
	private String RDSPReturnDate;
	
	@JsonProperty("ProductPickupDate")
	private String ProductPickupDate;
	...
	@JsonProperty("RDSPReturnDate")
	public String getRDSPReturnDate() {
		return RDSPReturnDate;
	}

	public void setRDSPReturnDate(String rDSPReturnDate) {
		RDSPReturnDate = rDSPReturnDate;
	}

	@JsonProperty("ProductPickupDate")
	public String getProductPickupDate() {
		return ProductPickupDate;
	}

	public void setProductPickupDate(String productPickupDate) {
