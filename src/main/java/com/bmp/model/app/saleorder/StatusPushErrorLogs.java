...
@Document(collection="statusPushErrorLogs")
@AssignKey(assvalue=true)
public class StatusPushErrorLogs extends MongoBaseBean implements Serializable {
	...
	public void setErrorMsgDetails(String errorMsgDetails) {
