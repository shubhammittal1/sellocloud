...
public class Gatiresponse {
	...
	public Gatiresponse(){}
	public Gatiresponse(String requid, String result, String dOCKET_NUMBER, String dOCKET_STATUS, String cONSIGNOR_NAME,
			String cONSIGNEE_NAME, String bOOKING_STATION, String bOOKED_DATETIME, String aCTUAL_WEIGHT,
			String nO_OF_PKGS, String sERVICE_NAME, String dELIVERY_STATION, String aSSURED_DELIVERY_DATE,
			TRANSIT_DTLS tRANSIT_DTLS, String pOD) {
		super();
		this.requid = requid;
		this.result = result;
	...
	public static class TRANSIT_DTLS{
		...
		public TRANSIT_DTLS(){}
		public TRANSIT_DTLS(List<Gatiresponse.TRANSIT_DTLS.ROW> rOW) {
			super();
			ROW = rOW;
		}
		@XmlElement(name="ROW")
