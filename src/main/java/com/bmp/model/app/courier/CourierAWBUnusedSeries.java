...
@Document(collection="courierAWBUnusedSeries")
@AssignKey(assvalue=false)
public class CourierAWBUnusedSeries extends MongoBaseBean implements Serializable {
